...
namespace Sjoerd.Miniaudio
{
    public static unsafe partial class ma
    {
        ...
        [DllImport("miniaudio", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ma_node_graph_get_processing_size_in_frames", ExactSpelling = true)]
        [return: NativeTypeName("ma_uint32")]
        public static extern uint node_graph_get_processing_size_in_frames([NativeTypeName("const ma_node_graph *")] ma_node_graph* pNodeGraph);
        ...
        [DllImport("miniaudio", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ma_sound_reset_start_time", ExactSpelling = true)]
        public static extern void sound_reset_start_time(ma_sound* pSound);

        [DllImport("miniaudio", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ma_sound_reset_stop_time", ExactSpelling = true)]
        public static extern void sound_reset_stop_time(ma_sound* pSound);

        [DllImport("miniaudio", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ma_sound_reset_fade", ExactSpelling = true)]
        public static extern void sound_reset_fade(ma_sound* pSound);

        [DllImport("miniaudio", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ma_sound_reset_stop_time_and_fade", ExactSpelling = true)]
        public static extern void sound_reset_stop_time_and_fade(ma_sound* pSound);
