...
namespace Sjoerd.Miniaudio
{
    ...
    {
        [NativeTypeName("__AnonymousRecord_miniaudio_L2697_C5")]
        ...
        [NativeTypeName("__AnonymousRecord_miniaudio_L2710_C5")]
        ...
        {
            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L2699_C9")]
        ...
        {
            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L2713_C9")]
            public _custom_e__Struct custom;

            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L2721_C9")]
            public _resourceManager_e__Union resourceManager;

            [FieldOffset(0)]
            [NativeTypeName("__AnonymousRecord_miniaudio_L2799_C9")]
            ...
            {
                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2723_C13")]
                ...
                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2742_C13")]
                public _pageDataBufferNode_e__Struct pageDataBufferNode;

                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2751_C13")]
                public _loadDataBuffer_e__Struct loadDataBuffer;

                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2764_C13")]
                public _freeDataBuffer_e__Struct freeDataBuffer;

                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2771_C13")]
                public _loadDataStream_e__Struct loadDataStream;

                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2780_C13")]
                public _freeDataStream_e__Struct freeDataStream;

                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2786_C13")]
                public _pageDataStream_e__Struct pageDataStream;

                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2791_C13")]
            ...
            {
                [FieldOffset(0)]
                [NativeTypeName("__AnonymousRecord_miniaudio_L2801_C13")]
                ...
                {
                    [FieldOffset(0)]
                    [NativeTypeName("__AnonymousRecord_miniaudio_L2803_C17")]
